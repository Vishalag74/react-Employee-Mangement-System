...
const CompleteTask = ({ data }) => {
    return (
        <div className='w-full h-auto p-3 sm:p-4 md:p-5 bg-blue-200 rounded-xl sm:rounded-2xl shadow-md'>
            ...
            <div className='mt-3 sm:mt-4'>
                <button className='w-full bg-indigo-500 hover:bg-indigo-600 text-xs sm:text-sm text-white rounded-md shadow-md py-2 transition'>Completed</button>
            </div>
        </div>
    )
}
