...
const FailedTask = ({data}) => {
    return (
<div className='flex-shrink-0 h-full w-[300px] p-5 bg-red-200 rounded-2xl shadow-md'>
    ...
    <div className='mt-5'>
        <button className='w-full bg-red-500 hover:bg-red-600 text-white rounded-md shadow-md py-2 transition'>Failed</button>
    </div>
</div>
    )
}
